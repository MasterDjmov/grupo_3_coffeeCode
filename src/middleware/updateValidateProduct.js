...
const updateValidateProduct = [
    ...
    body('procesamiento_natural')
        .optional().isLength({ max: 50 }).withMessage('El procesamiento natural no debe superar los 100 caracteres'),

    body('procesamiento_lavado')
        .optional().isLength({ max: 50 }).withMessage('El procesamiento lavado no debe superar los 100 caracteres')
]

module.exports = updateValidateProduct;